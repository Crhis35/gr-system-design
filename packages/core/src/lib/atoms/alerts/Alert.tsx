...
export default function Alert<C extends ElementType = 'span'>(
  ...
  if (type === 'primary') {
    return (
      <div
        ...
        className="p-4 mb-4 text-blue-800 border border-blue-600 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800"
        role="alert"
        style={{
  ...
  return (
    <>
      <span className={alertClasses}></span>
    </>
  );
}
